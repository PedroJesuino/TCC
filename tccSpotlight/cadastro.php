	...
	<div class="limiter">
		<div class="container-login100">
			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
				<form action="cadastrar-usuario.php" method="POST" class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input" data-validate = "Repeat Password is required">
						...
						<input class="input100" type="text" id="pass-repeat" name="repeat-pass" placeholder="*************">
						<span class="focus-input100"></span>
					</div>
					...
					<div class="container-login100-form-btn">
						<div class="wrap-login100-form-btn">
							...
							<button   onclick="validarSenha()" type="submit" class="login100-form-btn">
								Cadastrar
							</button>
						</div>
